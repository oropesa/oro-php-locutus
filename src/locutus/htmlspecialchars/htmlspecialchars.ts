...
export const HTMLSPECIALCHARS_ENT_HTML_QUOTE_SINGLE: ENT_OPTION_STRING = 'ENT_HTML_QUOTE_SINGLE' as const;
export const HTMLSPECIALCHARS_ENT_HTML_QUOTE_DOUBLE: ENT_OPTION_STRING = 'ENT_HTML_QUOTE_DOUBLE' as const;
