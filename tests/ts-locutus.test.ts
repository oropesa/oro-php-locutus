...
describe( 'serialize', () => {
    ...
    test( 'serialize( arr2 )', () => {
        expect( serialize( [ 'chacho', '', true, false, 1, 2.3 ] ) )
            .toBe( 'a:6:{i:0;s:6:"chacho";i:1;s:0:"";i:2;b:1;i:3;b:0;i:4;i:1;i:5;d:2.3;}' )
    } );
} );
...
describe( 'unserialize', () => {
    ...
    test( 'unserialize( ser obj )', () => {
        expect( unserialize( 'a:2:{s:6:"chacho";b:1;s:3:"tio";i:17;}' ) ).toEqual( { chacho: true, tio: 17 } )
    } );
    test( 'unserialize( ser arr 2 )', () => {
        expect( unserialize( 'a:6:{i:0;s:6:"chacho";i:1;s:0:"";i:2;b:1;i:3;b:0;i:4;i:1;i:5;d:2.3;}' ) )
            .toEqual( [ 'chacho', '', true, false, 1, 2.3 ] )
    } );

    test( 'unserialize( ser param length )', () => {
        expect( unserialize( 'a:4:{s:5:"width";s:4:"2.55";s:6:"length";s:4:"2.27";s:8:"width_mm";s:3:"0.9";s:9:"length_mm";s:3:"0.8";}' ) )
...
describe( 'htmlspecialchars', () => {
    ...
    test( 'htmlspecialchars( html )', () => {
        expect( htmlspecialchars( '<a href="test">Test</a>', 'ENT_QUOTES' ) )
            .toBe( '&lt;a href=&quot;test&quot;&gt;Test&lt;/a&gt;' )
    } );
    test( 'htmlspecialchars( html1 )', () => {
        expect( htmlspecialchars( '<a href="test">Test</a>' ) )
            .toBe( "&lt;a href=&quot;test&quot;&gt;Test&lt;/a&gt;" )
    } );
    ...
    test( 'htmlspecialchars( html2 )', () => {
        expect( htmlspecialchars( "ab\"c'd", [ 'ENT_NOQUOTES', 'ENT_QUOTES' ] ) )
            .toBe( 'ab"c&#039;d' )
    } );
    test( 'htmlspecialchars( html3 )', () => {
        expect( htmlspecialchars( 'my "&entity;" is still here', null, null, false ) )
            .toBe( 'my &quot;&entity;&quot; is still here' )
    } );
} );
